    ...
    <div id='home' className="w-full h-screen text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-2 text-[#ecf0f3]">A Software Developer</h1>
          <p className="py-4 text-[#ecf0f3] max-w-[70%] m-auto">
            ...
            focused on building responsive full stack applications and system softwares.
          </p>
          <div className="flex items-center justify-between max-w-[330px] m-auto py-4">
            ...
            <a title='resume' href="https://drive.google.com/file/d/1XaYsCP4qSEEzYUCd2Y9n7uMiDEkZTBZg/view?usp=sharing" target='_blank' rel='noreferrer'>
            <div className="rounded-full shadow-md shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 text-[#fff">
